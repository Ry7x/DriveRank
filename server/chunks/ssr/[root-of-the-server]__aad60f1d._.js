...
"[project]/src/services/navigation/routeService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DrivingProvider({ children }) {
    ...
    const lastRerouteTimeRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(0);
    ...
    const [destination, setDestination] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [currentRoadName, setCurrentRoadName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("");
    const [distanceToNextStep, setDistanceToNextStep] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(0);
    const [remainingDistance, setRemainingDistance] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(0);
    const [remainingDuration, setRemainingDuration] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(0);
    const [dynamicZoom, setDynamicZoom] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(17);
    const [userZoomOverride, setUserZoomOverride] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const REROUTE_DISTANCE_THRESHOLD = 80;
    ...
    // Visibility change listener to re-request wake lock
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const handleVisibilityChange = async ()=>{
            if (document.visibilityState === 'visible' && (isDrivingRef.current || isNavigating)) {
    ...
    const handleDragLogic = (kmh, currentDist)=>{
        const now = performance.now();
        if (!isDragActiveRef.current && !isDragFinishedRef.current) {
            if (countdownRef.current > 0 && countdownRef.current < 5 && kmh > 1) {
                setIsJumpStart(true);
            }
            if (kmh > 0.5 && countdownRef.current === 5) {
            ...
            let finished = false;
            if (runMode === '0-60' && kmh >= 60) finished = true;
            else if (runMode === '0-100' && kmh >= 100) finished = true;
            else if (runMode === '100-200' && kmh >= 200) finished = true;
            else if (runMode === '1/4mile' && currentDist - dragStartDistRef.current >= 402.3) finished = true;
            if (finished) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (typeof navigator !== 'undefined' && navigator.geolocation) {
            watchId = navigator.geolocation.watchPosition((position)=>{
                setHasGps(true);
                const { latitude, longitude, speed: mps, heading: rawHeading } = position.coords;
                const kmh = mps !== null && mps >= 0.5 ? Math.round(mps * 3.6) : 0;
                if (isDrivingRef.current && runMode !== 'free' && !isDragFinishedRef.current) handleDragLogic(kmh, totalDistanceRef.current);
                setSpeed(kmh);
                setCurrentCoords({
                    lat: latitude,
                    lng: longitude
                ...
                if (finalHeading !== null && !isNaN(finalHeading)) setHeading(getSmoothedHeading(finalHeading));
                if (isDrivingRef.current) {
                    setRoutePoints((prev)=>{
                        const lastPoint = prev[prev.length - 1];
                        if (lastPoint && calculateDist(lastPoint[0], lastPoint[1], latitude, longitude) < 1.5) return prev;
                        return [
                            ...prev,
                            [
                                latitude,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (isNavigating && currentCoords && routeData && destination) {
            const steps = routeData.steps;
            let targetStep = null;
            for(let i = 0; i < steps.length; i++){
                const d = calculateDist(currentCoords.lat, currentCoords.lng, steps[i].location[0], steps[i].location[1]);
                if (d > 20) {
                    setDistanceToNextStep(Math.round(d));
                    targetStep = steps[i];
                    break;
                }
            }
            ...
            let closestIdx = -1, minCoordDist = 1000;
            for(let i = 0; i < coords.length; i++){
                const d = calculateDist(currentCoords.lat, currentCoords.lng, coords[i][0], coords[i][1]);
                if (d < minCoordDist) {
                    minCoordDist = d;
                    closestIdx = i;
                }
            ...
            if (closestIdx !== -1) {
                ...
                if (remainingCoords.length > 1) {
                    for(let i = 0; i < remainingCoords.length - 1; i++){
                        remainingD += calculateDist(remainingCoords[i][0], remainingCoords[i][1], remainingCoords[i + 1][0], remainingCoords[i + 1][1]);
                    }
                }
                setRemainingDistance(remainingD);
                setRemainingDuration(routeData.duration * (remainingD / (routeData.distance || 1)));
                setCurrentRoadName(routeData.steps[0]?.name || routeData.summary || "Rrugë e Kosovës");
            }
            if (userZoomOverride === null) {
                let targetZoom = 17;
                if (distanceToNextStep < 100) targetZoom = 19;
                else if (distanceToNextStep < 300) targetZoom = 18;
                else if (speed > 80) targetZoom = 14;
                else if (speed > 50) targetZoom = 16;
                if (Math.abs(dynamicZoom - targetZoom) > 0.5) setDynamicZoom(targetZoom);
            } else setDynamicZoom(userZoomOverride);
            if (minCoordDist > REROUTE_DISTANCE_THRESHOLD) {
                const now = Date.now();
                if (now - lastRerouteTimeRef.current > 8000) {
                    lastRerouteTimeRef.current = now;
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$navigation$2f$routeService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateRoutes"])(currentCoords, {
                        lat: destination.lat,
                        lng: destination.lng
                    }).then((routes)=>{
    ...
    const stopTrip = ()=>{
        if (isDrivingRef.current) {
            ...
            setLastRunSummary({
                id: Math.random().toString(36).substring(7),
                runType: runMode === 'free' ? 'Top Speed' : runMode === '1/4mile' ? '1/4 Mile' : runMode,
                time: runMode === 'free' ? duration : dragTime || 0,
                peakSpeed: peakSpeedRef.current,
                avgSpeed: Math.round(avgSpeed),
    ...
    const clearNavigation = ()=>{
        ...
        setUserZoomOverride(null);
        if (!isDrivingRef.current) releaseWakeLock();
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(DrivingContext.Provider, {
        value: {
            ...
            setIsNavigating,
            clearNavigation,
            setDynamicZoom: setUserZoomOverride,
            setRunMode,
            startTrip,
            startDragCountdown,
            stopTrip,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__aad60f1d._.js.map